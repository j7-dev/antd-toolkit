...
export const en_US: TLocale = {
	...
	WcProduct: {
		backorderNo: 'Do not allow',
		backorderYes: 'Allow',
		backorderNotify: 'Allow, but notify customer',
		stockInStock: 'In stock',
		stockOutOfStock: 'Out of stock',
		stockOnBackorder: 'On backorder',
		dateCreated: 'Date created',
		dateModified: 'Date modified',
		dateSaleFrom: 'Sale start date',
		dateSaleTo: 'Sale end date',
		typeSimple: 'Simple product',
		typeGrouped: 'Grouped product',
		typeExternal: 'External product',
		typeVariable: 'Variable product',
		typeVariation: 'Product variation',
		typeSubscription: 'Simple subscription',
		typeVariableSubscription: 'Variable subscription',
		typeSubscriptionVariation: 'Subscription variation',
		visibilityHidden: 'Hidden',
		visibilityVisible: 'Shop and search results',
		visibilitySearch: 'Search results only',
		visibilityCatalog: 'Shop only',
		filterKeyword: 'Keyword',
		filterSku: 'SKU',
		filterType: 'Product type',
		filterCategory: (label) => `${label} category`,
		filterTag: (label) => `${label} tag`,
		filterBrand: 'Brand',
		filterStatus: (label) => `${label} status`,
		filterFeatured: 'Featured',
		filterDownloadable: 'Downloadable',
		filterVirtual: 'Virtual',
		filterSoldIndividually: 'Sold individually',
		filterBackorders: 'Allow backorders',
		filterStockStatus: 'Stock status',
		filterDateCreated: (label) => `${label} publish date`,
		filterPriceRange: 'Price range',
		filterAuthor: 'Author',
		filterInclude: 'Include specific products',
	},
	WcOrder: {
